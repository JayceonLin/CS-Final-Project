...
void StartScreen::update()
{
    ...
    int button_x = DC->window_width / 2 - button_w / 2;
    int button_y = DC->window_height / 2 - button_h / 2;
...
void StartScreen::draw()
{
    ...
    // draw start button (pretty version)
    int button_w = 260;
    int button_h = 70;
    ...
    // button colors
    ALLEGRO_COLOR color_top    = hovering ? al_map_rgb(70, 170, 255) : al_map_rgb(0, 120, 255);
    ALLEGRO_COLOR color_bottom = hovering ? al_map_rgb(30, 120, 220) : al_map_rgb(0, 90, 200);
    ...
    // START text (slightly lower for better aesthetics)
    al_draw_text(
        FC->courier_new[FontSize::LARGE], al_map_rgb(255, 255, 255),
        DC->window_width / 2, button_y + button_h / 2 - 15,
